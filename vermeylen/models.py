...
class Input(db.Model):
    """Feedback given through input form"""
    id = db.Column(db.Integer, primary_key=True)
...
class VoterKey(db.Model):
    ...
    votes = db.relationship('ElectionOption', secondary=votes, backref=db.backref('keys'))
...
class Election(db.Model):
    ...
    options = db.relationship('ElectionOption',backref='election',cascade='delete')
